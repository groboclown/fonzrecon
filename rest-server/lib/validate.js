...
const ALPHANUMERIC_NAME_RE = /^[a-z][a-z0-9]+$/;
const SIMPLE_INT_RE = /^[-+]?[0-9]+$/;
...
exports.promiseReflect = function(p) {
  ...
  return p.then((v) => {
    ...
    return { e: e.details, status: 'rejected', error: e };
  });
};
...
exports.allValidationPromises = function(validations) {
  return Promise
    .all(validations.map(exports.promiseReflect))
    .then((results) => {
...
exports.isAlphanumericName = function(value) {
  if (typeof(value) !== 'string') {
    return false;
  }
  return ALPHANUMERIC_NAME_RE.test(value);
};
...
exports.isInt = function(value) {
  ...
  return SIMPLE_INT_RE.test('' + value);
};
